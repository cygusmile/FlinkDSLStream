...
import com.ximalaya.flink.dsl.stream.client.DslStreamLocalExecutor;
 ...
 */
@Public
public class DslStreamLocalEnvironment extends ExecutionEnvironment {
    ...
    private List<URL> extendJars;

    /**
     * Creates a new local environment.
     */
    public DslStreamLocalEnvironment(List<URL> extendJars) {
        this(new Configuration(),extendJars);
     ...
     */
    public DslStreamLocalEnvironment(Configuration config,List<URL> extendJars) {
        //todo
...
//        }
    ...
    public void setExtendJars(List<URL> extendJars) {
        this.extendJars = extendJars;
    }
    ...
    public void startNewSession() throws Exception {
        ...
        executor = new DslStreamLocalExecutor(configuration,extendJars);
