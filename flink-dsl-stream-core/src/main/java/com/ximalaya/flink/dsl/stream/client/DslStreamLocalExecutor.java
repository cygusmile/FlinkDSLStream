 ...
 */
public class DslStreamLocalExecutor extends PlanExecutor {
    ...
    public DslStreamLocalExecutor() {
        this(null, Lists.newArrayList());
    }

    public DslStreamLocalExecutor(Configuration conf,List<URL> extendJars) {
    ...
    public static JobExecutionResult execute(Plan plan) throws Exception {
        return new DslStreamLocalExecutor().executePlan(plan);
    }
