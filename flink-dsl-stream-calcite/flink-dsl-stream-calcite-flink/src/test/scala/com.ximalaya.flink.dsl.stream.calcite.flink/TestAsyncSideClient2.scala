...
class TestAsyncSideClient2 extends AsyncSideClient {
  ...
  override def query(value: Object): Future[(String, util.Map[String, Object])] = {
    Future.successful((sideTable, data.get(value)))
  }
  ...
  override def open(key: String, sideTable: String, physicsSchema: util.List[SourceField],
    ...
    value1.put("name", "maxxrk")
    data.put(Long.box(300L), value1)

    val value2 = Maps.newHashMap[String, Object]()
    value2.put("name", "mmxxm")

    data.put(Long.box(300L), value2)
  }
