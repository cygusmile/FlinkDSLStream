...
public class QueryExplodeWithFilterProcessFunction extends QuerySimpleExplodeWithFilterProcessFunction {

    private List<Evaluation> queries;
    private int explodeFieldIndex;

    public QueryExplodeWithFilterProcessFunction(Evaluation explodeFieldEvaluation,
                                                 Evaluation filterCondition,
                                                 String[] fields,
                                                 List<Evaluation> queries,
                                                 int explodeFieldIndex) {
        super(explodeFieldEvaluation, filterCondition, fields);
